...
namespace ApiDeNotaFiscal.Migrations
{
    ...
    [Migration("20241024191814_correcaoTabela")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClienteEmpresa", b =>
                {
                    ...
                    b.HasKey("ClientesClienteId", "EmpresasEmpresaId");
            ...
            modelBuilder.Entity("ClienteEmpresa", b =>
                {
                    b.HasOne("ApiDeNotaFiscal.Models.Cliente", null)
                        .WithMany()
                        .HasForeignKey("ClientesClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiDeNotaFiscal.Models.Empresa", null)
                        .WithMany()
